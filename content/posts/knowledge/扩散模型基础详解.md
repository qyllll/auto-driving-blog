...
categories: ["知识点拆解"]
tags: ["🎨 扩散模型","📐 数学基础","🌊 生成模型"]
summary: "扩散模型通过逐步加噪与逆向去噪实现从纯噪声到高质量数据的生成，已成为 GAN 之后最强大的生成范式。本文从 DDPM 的数学推导出发，详细讲解正向加噪过程、反向去噪网络以及条件生成方法。同时梳理了扩散模型在自动驾驶场景生成、轨迹规划中的数据增强应用全景。"
weight: 14
---
...
![DDPM前向加噪与反向去噪过程示意图](/images/diffusion-basics/ddpm.png)
...
![Classifier-free guidance原理：条件与无条件预测的插值](/images/diffusion-basics/cfg.png)
