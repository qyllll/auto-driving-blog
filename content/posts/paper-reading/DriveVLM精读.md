...
![DriveVLM 的 CoT 推理流程示例：从场景描述、场景分析到分层规划的全流程标注样本](/images/drivevlm/cot-flow.png)
...
![DriveVLM 与 DriveVLM-Dual 的整体架构：左侧为基于 VLM 的 CoT 推理（场景描述/分析/分层规划），右侧进一步融合传统 3D 感知与实时轨迹规划模块](/images/drivevlm/architecture.png)
