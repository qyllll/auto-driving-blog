...
- **[自动驾驶技术指南](https://yfrobotics.github.io/self-driving-handbook-cn/)**（GitHub Pages）— 云飞机器人实验室维护的系统性技术手册，覆盖从概述到实例的完整体系
- **[自动驾驶之心知识星球](https://blog.csdn.net/CV_Autobot/article/details/136753974)** — 4000+ 成员的自动驾驶学习社区，整合近 40+ 方向的技术栈学习路线
- **[自动驾驶全栈学习路线汇总](https://blog.csdn.net/CV_Autobot/article/details/136753974)**（CSDN）— 13 个主流方向的学习资料和论文清单
- **53AI 知识库** ([53ai.com](https://www.53ai.com)) — 大模型与AI应用知识库，含自动驾驶行业应用实践
- **技术栈社区** ([jishuzhan.net](https://jishuzhan.net)) — 自动驾驶领域热点简报，追踪政策和产业动态
- **KnowVal 驾驶知识图谱** (CVPR 2026) — 融合交规、防御性驾驶规范的知识增强驾驶系统
