...
![Flow-GRPO 思维导图](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_mindmap.svg)
...
![扩散模型 vs Flow Matching](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_fm_concept.svg)
...
![GRPO 组内竞争](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_grpo_concept.svg)
...
![概念关系图](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_concept_rel.svg)
...
![flow_grpo 代码仓库结构](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_repo_structure.svg)
...
![Flow-GRPO 训练循环总图](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_overview.svg)
...
![训练阶段计算图与梯度流](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_compute_graph.svg)
...
![旧模型和新模型是同一个模型的两个瞬间](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_old_new_model.svg)
...
![一次完整的训练迭代](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_training_iteration.svg)
...
![Flow-GRPO 代码架构](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_code_arch.svg)
...
![Flow Matching 去噪过程](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_flow_matching.svg)
...
![GRPO Advantage 计算](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_grpo_advantage.svg)
...
![Flow-GRPO-Fast SDE 窗口](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_fast_sde.svg)
...
![Flow-GRPO 完整逻辑链总结](https://auto-driving-blog.pages.dev/images/flowgrpo/flowgrpo_summary.svg)
